...
public class Events extends Node {
  ...
  public List<Event> topicsList;

  public Events(String ipAddr, int port) {
    super("", ipAddr, port);
  ...
  public void loadTopics() {
    ...
    for (File directory : directories) {
      ...
      topicsList.add(new Event("/" + directory.getName(), "", 0));
    }
  }
  ...
  public String publishMessageOperation(Message operation) {
    ...
    if (foundTopicId >= 0) {
      ...
      topicsList.add(new Event(topic, "", 0));
      System.out.println(
